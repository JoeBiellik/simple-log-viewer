...
namespace SimpleLogViewer
{
    ...
    public static class FlashWindow
    {
        ...
        {
            var fi = CreateFlashInfo(form.Handle, FLASHW_ALL | FLASHW_TIMERNOFG, uint.MaxValue, 0);
        ...
        {
            var fi = CreateFlashInfo(form.Handle, FLASHW_ALL, count, 0);
            return FlashWindowEx(ref fi);
        }
        ...
        {
            var fi = CreateFlashInfo(form.Handle, FLASHW_ALL, uint.MaxValue, 0);
            return FlashWindowEx(ref fi);
        }
        ...
        {
            var fi = CreateFlashInfo(form.Handle, FLASHW_STOP, uint.MaxValue, 0);
            return FlashWindowEx(ref fi);
        }

        private static FLASHWINFO CreateFlashInfo(IntPtr handle, uint flags, uint count, uint timeout)
        {
